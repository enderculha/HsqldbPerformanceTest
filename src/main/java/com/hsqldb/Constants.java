...
/* An example table is created on HSQLDB inmemory Database, indexes are also created for that table. b_number column is incremented
 * by 1 and inserted to DB on every insert execution 
 */
